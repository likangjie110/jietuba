...
# 可配置按钮的全集，也是默认顺序
DEFAULT_ORDER = (
    "long_screenshot", "save", "screenshot_translate", "text_recognize", "vision_read",
    "scan_code",
    "translate_in_place", "gif", "video",
...
DEFAULT_MORE = frozenset({"text_recognize", "vision_read", "scan_code", "spotlight", "video",
                          "line", "watermark", "filter", "smart_erase", "insert_image",
                          "loupe", "translate_in_place"})
